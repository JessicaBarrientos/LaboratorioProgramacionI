...
class Dados
{
    static void Main(string[] args)
    {
        ...
        juego.MostrarResultadosFinales(totalPartidas, tirosPartida);
    }
    ...
    private int tirosGanadosJugadorFinal;
    ...
    public void MostrarResultadosFinales(int totalPartidas, int tirosPartida)
    {
        Console.WriteLine("\n----RESULTADOS FINALES----");
        string ganador;
        ...
        double probabilidadDeGanar2 = (double)tirosGanadosJugadorFinal / (tirosPartida * totalPartidas);
        double probabilidadDeGanarporcentaje2 = probabilidadDeGanar2 * 100;
        probabilidadDeGanarporcentaje2 = Math.Round(probabilidadDeGanarporcentaje2, 2);
        Console.WriteLine("Probabilidades de ganar el juego por el jugador: " + probabilidadDeGanarporcentaje2 + "%");
